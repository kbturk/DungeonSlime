...
public class Bat
{
    ...
    ///<summary>
    ///Creates a new Bat using the specified animated sprite and soundEffect
    ///</summary>
    ///<param name="sprite">The AnimatedSprite to use when drawing teh bat.</param>
    ///<param name="bounceSoundEffect">The sound effect to play when the bat hits a wall</param>
