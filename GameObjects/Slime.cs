//There are two parts to a snake: a head and a tail.
...
public class Slime
{
    ...
    // Normalized value (0-1) representing progress between movement ticks vor visual interpulation.
    ...
    ///of the slime has collided with a body segment.
    ///</summary>
    ...
    /// </summary>
    /// <param name="sprite">The AnimatedSprite used when drawing the slime.</param>
    ...
    /// <summary>
    /// Initializes the slime, can be used to resest it back to an initial state.
    /// </summary>
    ...
    private void HandleInput()
    {
        ...
        //buttons at the same time correctly.
        //i.e. up and down means do not change course
    ...
    private void Move()
    {
        ...
        // the head is colliding with a body segment and a body collsion has occured.
    ...
    /// Updates the slime.
    /// </summary>
    /// <param name="gameTime">A snapshot of the timing values for the current udpate cycle</param>
    public void Update(GameTime gameTime)
    {
        ...
        // the movement time treshold, then perform a full movement.
    ...
    public void Draw()
    {
        ...
        foreach (SlimeSegment segment in _segments)
        {
            ...
            // Draw the slime sprite at the calculated visual position of the
            // segment
