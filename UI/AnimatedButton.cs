...
/// <summary>
/// A custom button implementation that inherits from  Gum's Button class to
/// provide animated visual feedback when focus.
/// </summary>
internal class AnimatedButton : Button
{
    ...
    {
        // Each gum form control has a general visual property that
        // has properties shared by all control types. This Visual
        // type matches the Form type. It can be casted to access
        ...
        // Get a reference ot the nine-slice background to display the button graphic
        // A nine-slice allows the button to stretch while preserving corner appearance
        // Works well for buttons and menus. Would look wild for other graphics.
        ...
        //Reset all state to default so we don't have unexpected variable assignemnts:
        ...
        //by cloning the enabled s tate since they appear the same
    ...
    ///<summary>
    ///Handles keyboard input for navination between buttons using left/right keys.
    ///</summary>
    private void HandleKeyDown(object sender, KeyEventArgs e)
    {
        //TODO: if both keys are down and change this to if else.
        if (e.Key == Keys.Left)
    ...
    ///<summary>
    ///Automatically focuses the button when the mosue hovers over it.
    ///</summary>
