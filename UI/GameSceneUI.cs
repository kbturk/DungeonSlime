...
public class GameSceneUI : ContainerRuntime
{
    ...
    /// <summary>
    /// Event invoked when the Quit button on either the Pause panel
    /// or Game Over panel is clicked.
    /// </summary>
    ...
    public GameSceneUI()
    {
        ...
        // Get a reference to the content manager that was registered with
        // the GumService when it was originally initialized.
        ...
        // Create the text that will dispaly the players score and add it as
    ...
    {
        // Button was clicked, play the ui sound effect for the auditory feedback.
    ...
    {
        // A ui element that can receive focus has received focus.
        // Play the ui sound effect for auditory feedback.
        Core.Audio.PlaySoundEffect(_uiSoundEffect);
    }
    ...
    public void ShowPausePanel()
    {
        ...
        // Ensure the other game over panel isn't visible.
        _gameOverPanel.IsVisible = false;
    }

    ///<summary>
    /// tells the game scene ui to hid the pause panel.
    ///</summary>
    ...
    ///</summary>
    ///<param name="gameTime">A snapshot of the timing value for the current update cycle.</param>
